                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="vertical-align: middle;">
                                    <img src="{{asset('galeri/'.$dt->gambar)}}" alt="" width="200" height="200">
                                </td>
                                <td style="vertical-align: middle;">{{ $dt->judul }}</td>
                                <td style="vertical-align: middle;">{{ $dt->deskripsi }}</td>
                                <td style="width: 16%;text-align: center">
                                    ...
                                    <a href="{{route('admin.galeri.destroy',[$dt->id])}}" class="btn btn-danger" title="Hapus Data"><i class="fa fa-remove"></i></span>
                                    </a>
            ...
            <form role="form" action="{{route('admin.galeri.store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="barang">Deskripsi</label>
